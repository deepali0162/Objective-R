setwd("C://Data Science//Assignments")
getwd()
##### Normality Test##################
library(readxl)
...
t.test(InterestRateWaiver,StandardPromotion,alternative = "two.sided",conf.level = 0.95,correct = TRUE,var.equal = T)#two sample T.Test
...
Johnytalkers<-read_excel("C:/Data Science/JohnyTalkers.xlsx")   # JohnyTalkers.xlsx
View(Johnytalkers) 
attach(Johnytalkers)
...
setwd("C:\\Data Science\\Assignments")
library(readxl)
Bahaman<-read_excel("C:/Data Science/Bahaman.xlsx") # Bahaman.xlsx
View(Bahaman)
attach(Bahaman)
...
#p-value = 0.7775 > 0.05 indicating that there is no significant difference
#between the group variances
